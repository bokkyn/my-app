...
const Tenable = () => {
  ...
  useEffect(() => {
    const fetchPrompt = async () => {
      try {
        const response = await axios.get("http://localhost:3000/prompts/random");
        ...
        const footballersResponse = await axios.post(
          "http://localhost:3000/footballers/query",
    ...
    const fetchFootballers = async () => {
      try {
        const response = await axios.get("http://localhost:3000/footballers");
